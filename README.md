...
2. Vá em **File (Arquivo)** > **Open Folder (Abrir Pasta)** e selecione:
   ...
   ```
   *(Ou abra o terminal e digite: `code C:\Users\acvin\.gemini\antigravity\scratch\lanchonete-da-helo`)*
...
|---|---|---|
| **Início** | `index.html` | Hero com destaque do lanche artesanal, categorias e banner institucional *"Feito com amor, servido pra você!"* |
...
- **Envio Automático para WhatsApp**: Ao clicar em *"Enviar Pedido no WhatsApp"*, o sistema formata a mensagem com a lista de itens, valores e total, abrindo a conversa pronta para envio!
